...
class Consola:
    ...
    def __adaugStudent(self):
        ...
        try:
            st = self.__srvs.adaugareStudent(str(self.__ids), nume)
            self.__ids += 1
    ...
    def __adaugDisciplina(self):
        ...
        try:
            dis = self.__srvd.adaugareDisciplina(str(self.__idd), denumire, profesor)
            self.__idd += 1
        ...
        try:
            ...
            if student:
                ...
                if discip:
                    ...
                    self.__srvn.adaugare_nota(self.__idn,idst, iddis, notaa)
                    self.__idn += 1
    ...
    def __statistica_alfabetic_nume(self):
        ...
        try:
            ...
            lista = self.__srvs.ad_nume_lista(lista_note)
    ...
    def __statistica_speciala(self):
        ...
        try:
            ...
            self.__srvn.ordonare_nume_s5(listaspec)
